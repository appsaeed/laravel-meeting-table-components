<div
    ...
    <p class="text-[smaller]"><b>Unlimited classes for 30 days is £30.</b> <i class="fa-solid fa-star"></i>A
        simple subscription you can start and stop at the click of a button. This is our regular price, not
        just a
        special offer.
        Alternatively you can pay £12 for just this class. Click 'book in' to get started.</p>
    <p>&nbsp;</p>
    <form action="passOptions.php" method="post" enctype="multipart/form-data">

        <input type="hidden" name="timetableID" value="3394">
        <input type="hidden" name="classDate" value="2024-08-28">


        <div
            class="[@media_screen_and(max-width:480px)]:text-[16px] flex items-center justify-center w-full mb-[20px] text-center">
            <div>
                <input class="appearance-none hidden peer" type="radio" name="timetableID" id="studio"
                    value="3394" checked>
                <label
            ...
            <div>
                <input class="appearance-none hidden peer" type="radio" name="timetableID" id="zoom"
                    value="3029">
                <label
                    class='text-[18px] font-["Josefin_Sans",_Helvetica,_Arial,_sans-serif] font-black text-[rgb(53,_54,_53)] flex justify-center items-center w-[185px] h-[48px] overflow-hidden [transition:linear_0.3s] rounded-[10px] border-[2px] border-[solid] border-[#dddddd] mr-[30px] cursor-pointer peer-checked:border-[#f6901c] peer-checked:bg-[#fff] peer-checked:text-[#f6901c] peer-checked:font-extrabold peer-checked:transition-all peer-checked:duration-[0.3s]'
                    for="zoom">
