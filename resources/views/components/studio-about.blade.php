<div class="mx-[auto] my-0 w-[800px] [@media_screen_and(max-width:820px)]:w-auto [@media_screen_and(max-width:480px)]:w-auto">
    <h2
    ...
    <p
        ...
        Suitable for all. A flowing class that connects mind, body, movement and breath, united with
        relaxing
        music.<br>This class will invite you to listen to your body through a mix of dynamic flows, and
        energising
        postures to nourish and challenge your body.
    </p>
</div>